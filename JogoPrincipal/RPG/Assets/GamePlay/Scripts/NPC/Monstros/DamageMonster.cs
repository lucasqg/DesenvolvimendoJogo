...
public class DamageMonster : MonoBehaviour
{
    ...
    public void applyDamageNPC(int dano, NpcBase npcMissao)
    {
        npcMissao.addLife(-dano);
    }
    public void OnTriggerStay2D(Collider2D collision)
    {
        ...
        else if(collision.tag == "Bandeira" && ContadorDeTempo > monstro.velTotal)
        {
            applyDamageNPC(monstro.danoTotal, collision.GetComponent<Bandeira>());
            ContadorDeTempo = 0;
        }
    }
